/*
  ...
  Arduino Pro or Pro Mini (5V, 16 MHz) w/ ATmega328P: same 8-analog-input
  ...
  this 5V/16MHz variant and a 3.3V/8MHz variant (see ../pro3v3/), which
  ...
  representing the 5V/16MHz half of that menu.
*/
