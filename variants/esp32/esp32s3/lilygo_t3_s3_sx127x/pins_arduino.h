...
// P2 (pfodWeb NOTE: PIN_33/34/36/8 deliberately NOT declared — those
// header positions are wired to the same GPIOs as LORA_DIO1/DIO2/DIO5/
// RST above, not free general-purpose pins)
