...
// =============================================
// SPI (pfodWeb NOTE: MOSI/MISO/SCK/SS deliberately NOT declared as
// pins — SS is literally the same pin as PIN_SD_CS below, i.e. this
// whole bus is the built-in onboard microSD card's SPI bus, not a
// free general-purpose SPI header; see this board's own board.json
// chipGpios override)
// =============================================
