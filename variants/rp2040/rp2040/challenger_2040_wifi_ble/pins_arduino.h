...
// pfodWeb NOTE: D15-D21 deliberately NOT declared — GPIO12/13/14/15 are
// the SPI1 link to the onboard ESP32-C3 WiFi/BLE co-processor
// (PIN_SPI1_MISO/SS/SCK/MOSI, "ESP hosted" protocol), GPIO18 is the
// handshake line (PIN_ESP32_HS), GPIO19/24 are its reset/mode control
// lines (PIN_ESP32_RST/PIN_ESP32_MODE). None are general-purpose.
