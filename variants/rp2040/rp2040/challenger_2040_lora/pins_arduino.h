...
// pfodWeb NOTE: D14-D17 deliberately NOT declared — GPIO13/14/15/18 are
// the RFM95W LoRa module's RST/DIO0/DIO1/DIO2 lines, not general-purpose
// (GPIO9-12, the module's SPI1 bus, are already correctly excluded above).
