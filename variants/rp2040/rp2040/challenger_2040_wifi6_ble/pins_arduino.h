...
// the SPI1 link to the onboard ESP32-C6 WiFi6/BLE5 co-processor
// (PIN_SPI1_MISO/SS/SCK/MOSI, "ESP hosted" protocol), GPIO18 is the
// handshake line, GPIO19/24 are its reset/mode control lines
// (PIN_ESP32_RST/PIN_ESP32_MODE). None are general-purpose.
