...
// pfodWeb NOTE: D20/D24-D29 deliberately NOT declared — confirmed via
// Arduino's own Nano RP2040 Connect documentation that GPIO2/3/8/9/10/11/14
// are dedicated to the onboard u-blox NINA-W102 WiFi/BLE module (SPI1 link,
// reset, and GPIO0 lines) and are not general-purpose:
//   D20=GPIO2 (NINA_GPIO0), D24=GPIO3 (NINA_RESETN), D25=GPIO8 (NINA SDI),
//   D26=GPIO9 (NINA CS), D27=GPIO10 (NINA ACK), D28=GPIO11 (NINA SDO),
//   D29=GPIO14 (NINA SCK).
