...
// pfodWeb NOTE: D0-D3 deliberately NOT declared (the vendor's own file
// marks them "Internal to the board") — GPIO0/1 are the UART to the
// onboard ESP8285 WiFi co-processor (PIN_SERIAL1_TX/RX), GPIO2/3 are its
// PIN_ESP_RESET/PIN_ESP_MODE control lines. Not general-purpose.
