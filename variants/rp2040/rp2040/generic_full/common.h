...
// pfodWeb NOTE: this is the "full 30-pin" variant of ../generic/common.h,
// for boards confirmed (via vendor pinout documentation) to genuinely
// expose GPIO23/24/25/29 as usable pins — unlike the official Raspberry
// Pi Pico reference design, where these 4 are reserved for onboard SMPS
// power-save control, VBUS sense, the onboard LED, and VSYS-divider
// sensing respectively (see ../generic/common.h). Boards that include
// this file instead of ../generic/common.h have been individually
// verified against their manufacturer's own pinout/schematic docs.
...
/*
 * pfodWeb NOTE: the upstream arduino-pico common.h has a SECOND branch
 * here for the exotic 48-pin RP2350B package — deliberately removed, see
 * ../generic/common.h for the full rationale (no board using THIS file
 * is RP2350B either).
 */
