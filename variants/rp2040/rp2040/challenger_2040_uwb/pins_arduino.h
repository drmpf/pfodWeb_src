...
// pfodWeb NOTE: D14-D16 deliberately NOT declared — GPIO13/14/15 are the
// DWM3000 UWB module's RST/IRQ/WAKEUP lines, not general-purpose
// (GPIO9-12, the module's SPI1 bus, already excluded above). GPIO18
// (D17) is NOT DWM3000-dedicated on this board, so it stays available.
