...
// pfodWeb NOTE: this is the SparkFun XRP robotics controller (full/non-
// beta) — GPIO2/3 (Motor4 encoder), GPIO6-9 (Servo1-4), GPIO10/11
// (Motor4 IN1/IN2), GPIO20/21 (Motor3 IN1/IN2) and GPIO22 (Motor3
// encoder A) are dedicated to onboard motor/servo hardware (see the XRP
// pin-name #defines above), so they're deliberately NOT declared here —
// matching the same audit applied to sparkfun_xrp_controller_beta. Kept:
// the distance sensor (GPIO0/1), I2C (GPIO4/5), Serial1/SPI1 (GPIO12-15)
// and SPI0 (GPIO16-19). The many other motor/encoder/current-sense pins
// this board exposes above GPIO29 (real on this genuinely-RP2350B chip)
// are not exposed at all, matching this chip bucket's conservative
// 26-pin default fallback.
