/**
 ...
 Before running this code.
  ...
  d) From the pfodParse library, in sub-directory pfodWeb, open pfodWeb.html in any web brower
     and select TCP/IP connection,  follow the pfodProxy instructions to start the pfodProxy
     fill in the IP for this board and Connect via pfodProxy
*/
